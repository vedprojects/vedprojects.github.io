...
ctrHref=trimTrailingSlash('https://free-hit-counters.net/'.trim());ctrHref2=trimTrailingSlash('https://free-hit-counters.net/'.trim());eInDoc=function(e){while(e=e.parentNode){if(e==document){return true;}}
